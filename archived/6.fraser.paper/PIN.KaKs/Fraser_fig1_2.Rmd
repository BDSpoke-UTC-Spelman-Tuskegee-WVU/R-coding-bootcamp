...
There are three key dataset in Fraser paper: evolutionary distances, protein interactions, and growth fitness. First, we need load the 3 data sets into R. Second, we need to do some 'informatics' to merge the three datasets. 
...
# Figure 1
Now, we want to regenerate Figure 1 in Fraser. We have degree and Ka, Ks in 'data', and we want  run lm() between degree and Ka. If we try: 
...
## Comment: 
### Merge heterogenous datasets is an important data science
###           and practical skill. 
#### end of merging
